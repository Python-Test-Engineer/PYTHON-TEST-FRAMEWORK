...
from src.cucumbers import CucumberBasket


scenarios("../../features/cucumbers_04.feature")
...
@when(
    parsers.cfparse(
        '"{some:Number}" cucumbers are removed from the basket', extra_types=EXTRA_TYPES
    )
)
