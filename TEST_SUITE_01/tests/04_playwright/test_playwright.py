...
def test_select_domains_link(page: Page) -> None:
    """Doc"""
...
def test_select_numbers_link(page: Page) -> None:
    """Doc"""
    main_page = MainPage(page)
    ican_navigation = IcanNavigationMenu(page)
...
def test_select_protocols_link(page: Page) -> None:
    """Doc"""
    main_page = MainPage(page)
    ican_navigation = IcanNavigationMenu(page)
...
def test_select_about_us_link(page: Page) -> None:
    """Doc"""
    main_page = MainPage(page)
    ican_navigation = IcanNavigationMenu(page)
